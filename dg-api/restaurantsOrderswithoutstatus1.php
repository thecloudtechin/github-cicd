...
if (mysqli_num_rows($result) > 0)
{
    while ($row = mysqli_fetch_assoc($result))
    {
      ...
      if( $row["day"] == "" || $currentDate >= $row["day"] || $row["day"] == "null" || $row["o_status"] == "12" ){
 ...
 $row_array['hotel_id'] = $row["hotel_id"];
        ...
        else
        {
            ...
            if (mysqli_num_rows($result_inner) == 1)
            {
                ...
                {
                    $row_array['home_address'] = $row1["address"] . "\n\n  Delivery Instruction : " . $row1["landmark"] . "";
                }
            }
        }
